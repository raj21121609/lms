        ...
        <div className='w-[70%] min-h-[600px]'>
          <div className='flex gap-5 items-baseline'>
            ...
            <div className='flex gap-3 text-[15px] font-[400]'>
              ...
              <div className='text-blue-600 text-[15px] font-[400]'>Checkout</div>
            </div>
          </div>
...
<div className='h-[600px] w-[800px] p-4 border-2 border-gray-300 mt-6 rounded-lg'>
  ...
  <div className="grid grid-cols-2 gap-4">
    <div className="flex flex-col">
      <label className="text-gray-700 mb-1 font-medium">Country</label>
      <input
        type="text"
    ...
    <div className="flex flex-col">
      <label className="text-gray-700 mb-1 font-medium">State/Union Territory</label>
      <input
        type="text"
    ...
    <div className="mt-3 border rounded-lg p-4 bg-gray-100">
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <div className="flex flex-col col-span-2">
          <label className="text-gray-700 mb-1 font-medium">Name of Card</label>
          <input
            type="text"
        ...
        <div className="flex flex-col col-span-2">
          <label className="text-gray-700 mb-1 font-medium">Card Number</label>
          <input
            type="text"
        ...
        <div className="flex flex-col">
          <label className="text-gray-700 mb-1 font-medium">Expiry Date</label>
          <input
            type="text"
            placeholder="MM/YY"
            className="border rounded-md h-10 px-3 outline-none bg-white focus:border-blue-500"
        ...
        <div className="flex flex-col">
          <label className="text-gray-700 mb-1 font-medium">CVC/CVV</label>
          <input
            type="text"
            placeholder="123"
            className="border rounded-md h-10 px-3 outline-none bg-white focus:border-blue-500"
      ...
      />
        ...
        <div className='w-[30%] min-h-[600px]'>
          ...
          <div className='h-[120px] w-[350px] bg-gray-100 border-2 border-gray-300 rounded-2xl flex items-center px-2 mt-4'>
            <img className='w-[100px] h-[100px] rounded-md mr-4' src={intro} alt="" />
            <div className='text-[14px]'>
              <div className='text-blue-500'>Design</div>
              <div className='font-[600]'>Introduction to User <br /> Experience Design</div>
