    ...
    <div className='w-1/2 ml-20'>
        ...
        <form>
            <div className='font-[500] mt-10'>
                ...
                <input className='mt-1 h-11 w-[490px] border border-gray-300 rounded-md px-3 text-sm focus:ring-1 focus:ring-black' type="text" placeholder='Enter your username' value={email} onChange={(e) => setEmail(e.target.value)} />
            </div>
