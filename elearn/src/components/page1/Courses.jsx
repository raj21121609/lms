...
const Courses = () => {
  return (
    ...
    <div className='flex justify-between px-20 mb-8'>
        <div className='text-xl font-[500]'>Top Courses</div>
    ...
    <div className='px-20 flex justify-between'>
        <div className='h-[283px] w-[260px] p-3 border-2 rounded-xl shadow-lg border-gray-200 shadow-gray-100 flex flex-col'>
            ...
            <div className='text-[14px] text-gray-700'>By Ronald Richards</div>
                ...
                <label for="star5" class="cursor-pointer text-yellow-400 peer-hover/star5:text-yellow-500 peer-checked/star5:text-yellow-500">★</label>

                <input type="radio" id="star4" name="rate" value="4" checked class="hidden peer/star4" />
                <label for="star4" class="cursor-pointer text-yellow-400 peer-hover/star4:text-yellow-500 peer-checked/star4:text-yellow-500">★</label>

                <input type="radio" id="star3" name="rate" value="3" checked class="hidden peer/star3" />
                <label for="star3" class="cursor-pointer text-yellow-400 peer-hover/star3:text-yellow-500 peer-checked/star3:text-yellow-500">★</label>

                <input type="radio" id="star2" name="rate" value="2" checked class="hidden peer/star2" />
                <label for="star2" class="cursor-pointer text-yellow-400 peer-hover/star2:text-yellow-500 peer-checked/star2:text-yellow-500">★</label>

                <input type="radio" id="star1" name="rate" value="1" class="hidden peer/star1" />
                <label for="star1" class="cursor-pointer text-yellow-400 peer-hover/star1:text-yellow-500 peer-checked/star1:text-yellow-500">★</label>
            </div>
