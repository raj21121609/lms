  ...
  return (
    <div className='flex justify-center gap-14 items-center w-full h-16 border-b-2 border-gray-200 px-4 '>
        ...
        <div className='flex items-center gap-5'>
            <div className='flex text-[#2C3E50] items-center'><img className='h-10 w-10' src={logo} alt="" /> Myway</div>
    ...
    <div className='flex gap-5 items-center pr-2'>
        <div><ShoppingCart color="#2C3E50" /></div>
        <button className='border-2 py-2 px-3 text-[#2C3E50]'>Log In</button>
        <button className='border-2 text-white bg-[#2C3E50] py-2 px-3'>Sign Up</button>
    </div>
